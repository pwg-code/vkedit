...
import IconDragIndicator from '~icons/ph/dots-six-vertical-light'
import IconMoreVert from '~icons/ph/dots-three-vertical-light'
import IconVerticalAlignTop from '~icons/ph/arrow-line-up-light'
import IconArrowUpward from '~icons/ph/arrow-up-light'
import IconArrowDownward from '~icons/ph/arrow-down-light'
import IconVerticalAlignBottom from '~icons/ph/arrow-line-down-light'
import IconEdit from '~icons/ph/pencil-simple-light'
import IconContentCopy from '~icons/ph/copy-light'
import IconDelete from '~icons/ph/trash-light'
import IconLock from '~icons/ph/lock-light'
import IconLockOpenRight from '~icons/ph/lock-open-light'
import IconVisibility from '~icons/ph/eye-light'
import IconVisibilityOff from '~icons/ph/eye-slash-light'
import IconCircle from '~icons/ph/circle-light'
